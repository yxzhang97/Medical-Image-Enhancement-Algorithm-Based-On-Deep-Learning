...
def process_command_args(arguments):
    ...
    # batch_size = 50
    batch_size = 5 # edited by quindex
    # train_size = 30000
    train_size = 100    #edited by quindex
    # learning_rate = 5e-4
    learning_rate = 0.0005   #edited by quindex
    # num_train_iters = 20000     #training iterations
    num_train_iters = 100    #edited by quindex

    w_content = 10  #content loss
    w_color = 0.5   #color loss
    w_texture = 1   #texture loss
    w_tv = 2000     #total variation loss

    dped_dir = 'data/'  #path to dataset
    vgg_dir = 'vgg_pretrained/imagenet-vgg-verydeep-19.mat' #path to VGG-19 network
    # eval_step = 1000    #Evaluation step
    eval_step = 50   #edited by quindex
